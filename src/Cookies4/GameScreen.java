...
public static boolean isSkillProceed= false;
	...
	skillInfo si= new skillInfo(skillName);
...
//(int)(1.5*si.mobHp)
	...
	g.setColor(Color.GREEN);
	g.fillRect(900, 450,  (int)(1.5*ms.monsterList.get(1).getHp()), 50);
	g.setColor(Color.GREEN);
	g.fillRect(1100, 250, (int)(1.5*ms.monsterList.get(2).getHp()), 50);
	g.setColor(Color.GREEN);
	g.fillRect(1100, 450, (int)(1.5*ms.monsterList.get(3).getHp()), 50);
	g.setColor(Color.GREEN);
	g.fillRect(1300, 350,  (int)(1.5*ms.monsterList.get(4).getHp()), 50);
